...
def login(driver):
    ...
    submit.click()
    print("> loging in")
    print("> wait for the pages to load (5 seconds)")
    time.sleep(5)
...
def basic_setup(driver):
    ...
    print("> load https://www.instagram.com/ichbinsophiescholl/ and wait 5 seconds")
...
def test():
    ...
    return driver, distinct_links


driver, distinct_links = test()